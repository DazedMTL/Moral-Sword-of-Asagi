...
# バージョン   ： rev-19.5(2018-12-18)
# 作者         ： WF-RGSS担当 (WHITE-FLUTE)
...
#==============================================================================
# - 2021/03/22 tsadao ボイスのフォルダパスを SE に設定
# - 2021/03/22 ahriman Voice機能だけ残してその他の機能（BGM,BGS,ME,SE）をオミット
#==============================================================================
...
unless defined? Audio::BGM
  ...
  module Audio
    begin
      @audio_init = Win32API.new('wfAudioLite','initialize','v','l')
      @audio_dispose = Win32API.new('wfAudioLite','dispose','v','v')
      @audio_play = Win32API.new('wfAudioLite','playBGM',%w(p i i p),'l')
      @audio_meplay = Win32API.new('wfAudioLite','playME',%w(p i i),'l')
      @audio_stop = Win32API.new('wfAudioLite','stop','v','v')
      @audio_stopsecond = Win32API.new('wfAudioLite','stopSecond','v','v')
      @audio_stopb = Win32API.new('wfAudioLite','stopBoth','v','v')
      @audio_stopme = Win32API.new('wfAudioLite','stopME','v','v')
      @audio_memory = Win32API.new('wfAudioLite','SeekMemorise','v','n')
      @audio_set = Win32API.new('wfAudioLite','SeekSet','v','n')
      @audio_clear = Win32API.new('wfAudioLite','SeekClear','v','v')
      @audio_pause = Win32API.new('wfAudioLite','Pause','v','v')
      @audio_resume = Win32API.new('wfAudioLite','Resume','v','v')
      @audio_cross = Win32API.new('wfAudioLite','setCrossFade','i','l')
      @audio_bgmfade = Win32API.new('wfAudioLite','fadeBGM','i','l')
      @audio_bgsfade = Win32API.new('wfAudioLite','fadeBGS','i','l')
      @audio_mefade = Win32API.new('wfAudioLite','fadeME','i','l')
      @audio_rtp = Win32API.new('wfAudioLite','getRTPPath',%w(p p i),'l')
      @audio_plays = Win32API.new('wfAudioLite' , 'playSecond' , %w(p i i i p) , 'l')
      @audio_balance = Win32API.new('wfAudioLite','balanceSet','i','v')
      @audio_seplay = Win32API.new('wfAudioLite','playSE',%w(p i i),'l')
      @audio_stopse = Win32API.new('wfAudioLite','stopSE','v','v')
      @audio_bgsplay = Win32API.new('wfAudioLite','playBGS',%w(p i i p),'l')
      @audio_stopbgs = Win32API.new('wfAudioLite','stopBGS','v','v')
      @audio_isbgm = Win32API.new('wfAudioLite','isPrimaryBGMPosition','v','n')
      @audio_isbgms = Win32API.new('wfAudioLite','isSecoundryBGMPosition','v','n')
      @audio_isbgs = Win32API.new('wfAudioLite','isBGSPosition','v','n')
      @audio_bgmpan = Win32API.new('wfAudioLite','primaryBGMPan','i','v')
      @audio_secondpan = Win32API.new('wfAudioLite','secondryBGMPan','i','v')
      @audio_bgspan = Win32API.new('wfAudioLite','BGSPan','i','v')
      @audio_mepan = Win32API.new('wfAudioLite','MEPan','i','v')
      @audio_sepan = Win32API.new('wfAudioLite','SEPan','i','v')
      @audio_pbgmreverb = Win32API.new('wfAudioLite','primaryBGMReverb',%w(i i),'v')
      @audio_sbgmreverb = Win32API.new('wfAudioLite','secondryBGMReverb',%w(i i),'v')
      @audio_bgsreverb = Win32API.new('wfAudioLite','BGSReverb',%w(i i),'v')
      @audio_mereverb = Win32API.new('wfAudioLite','MEReverb',%w(i i),'v')
      @audio_sereverb = Win32API.new('wfAudioLite','SEReverb',%w(i i),'v')
      @audio_pbgmeffect = Win32API.new('wfAudioLite','primaryBGMEffect',%w(i i),'v')
      @audio_sbgmeffect = Win32API.new('wfAudioLite','secondryBGMEffect',%w(i i),'v')
      @audio_bgseffect = Win32API.new('wfAudioLite','BGSEffect',%w(i i),'v')
      @audio_meeffect = Win32API.new('wfAudioLite','MEEffect',%w(i i),'v')
      @audio_seeffect = Win32API.new('wfAudioLite','SEEffect',%w(i i),'v')
      @audio_pbgmeffectd = Win32API.new('wfAudioLite','primaryBGMEffectDetail',%w(i i),'v')
      @audio_sbgmeffectd = Win32API.new('wfAudioLite','secondryBGMEffectDetail',%w(i i),'v')
      @audio_bgseffectd = Win32API.new('wfAudioLite','BGSEffectDetail',%w(i i),'v')
      @audio_meeffectd = Win32API.new('wfAudioLite','MEEffectDetail',%w(i i),'v')
      @audio_seeffectd = Win32API.new('wfAudioLite','SEEffectDetail',%w(i i),'v')

      @audio_vceffectd = Win32API.new('wfAudioLite','voiceEffectDetail',%w(i i),'v')
      @audio_vceffect = Win32API.new('wfAudioLite','voiceEffect',%w(i i),'v')
      @audio_vcreverb = Win32API.new('wfAudioLite','voiceReverb',%w(i i),'v')
      @audio_vcpan = Win32API.new('wfAudioLite','voicePan','i','v')
      @audio_isvcn = Win32API.new('wfAudioLite','isVoicePositionNumber','i','n')
      @audio_isvcf = Win32API.new('wfAudioLite','isVoicePositionFileName','p','n')
      @audio_vclenn = Win32API.new('wfAudioLite','voiceLengthNumber','i','n')
      @audio_vclenf = Win32API.new('wfAudioLite','voiceLengthFileName','p','n')
      @audio_vcpingn = Win32API.new('wfAudioLite','isVoicePlayingNumber','i','i')
      @audio_vcpingf = Win32API.new('wfAudioLite','isVoicePlayingFileName','p','i')
      @audio_stopvc = Win32API.new('wfAudioLite','stopVoice','v','v')
      @audio_vcplay = Win32API.new('wfAudioLite','playVoice',%w(p i i i),'l')

      @audio_pbgmlen = Win32API.new('wfAudioLite','primaryBGMLength','v','n')
      @audio_sbgmlen = Win32API.new('wfAudioLite','secondryBGMLength','v','n')
      @audio_bgslen = Win32API.new('wfAudioLite','BGSLength','v','n')
      @audio_pbgmloop = Win32API.new('wfAudioLite','isPrimaryBGMLoopEnd','v','i')
      @audio_sbgmloop = Win32API.new('wfAudioLite','isSecondryBGMLoopEnd','v','i')
      @audio_bgsloop = Win32API.new('wfAudioLite','isBGSLoopEnd','v','i')
      @audio_vcpermiln = Win32API.new('wfAudioLite','isVoicePositionPermilNumber','i','i')
      @audio_vcpermilf = Win32API.new('wfAudioLite','isVoicePositionPermilFileName','p','i')

      @audio_pbgmcheck = Win32API.new('wfAudioLite','isPrimaryBGMCheckPoint','l','i')
      @audio_sbgmcheck = Win32API.new('wfAudioLite','isSecoundryBGMCheckPoint','l','i')
      @audio_bgscheck = Win32API.new('wfAudioLite','isBGSCheckPoint','l','i')
      @audio_cue = Win32API.new('wfAudioLite','cuePrimaryBGM','v','v')
      @audio_pbgm_reserve = Win32API.new('wfAudioLite','reservePrimaryBGM',%w(p i i l l i),'l')
      @audio_pbgm_reserve_m = Win32API.new('wfAudioLite','reservePrimaryBGMMemory',%w(p p i i l l i),'l')
    rescue Exception
      raise if debug?
      raise(LoadError,"cannot read modules.(wfAudioLite.dll)")
    end
...
#~     end
    ...
    # -------------------------------------------------------------------------
    def Audio.ogg_init
      ret = @audio_init.call() unless @audio__init
    ...
    # -------------------------------------------------------------------------
    def Audio.dispose
      @audio_dispose.call() if init_check
      @audio__init = false
    end
#~     # -------------------------------------------------------------------------
#~     # ● 再生位置取得
...
unless rpgvxace?
  unless rpgvx?
    class Game_System
      def playing_bgm_load
        return @playing_bgm if @playing_bgm
        RPG::BGM.new
      end
      def playing_bgs_load
        return @playing_bgs if @playing_bgs
        RPG::BGS.new
      end
    end
    class Scene_Load
      def on_decision(filename)
        ...
        $game_system.bgm_play($game_system.playing_bgm_load)
        $game_system.bgs_play($game_system.playing_bgs_load)
        $game_map.update
        $scene = Scene_Map.new
      end
    end
